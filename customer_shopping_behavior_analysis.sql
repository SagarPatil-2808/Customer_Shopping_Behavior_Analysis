...
CHANGE `purchase_amount(usd)` purchase_amount DECIMAL(10, 2);
...
SELECT subscription_status,COUNT(customer_id) AS total_customer, AVG(purchase_amount) AS avg_spend, SUM(purchase_amount) AS revenue
FROM customer 
